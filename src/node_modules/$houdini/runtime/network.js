...
exports.RequestContext = exports.getEnvironment = exports.setEnvironment = exports.Environment = exports.fetchQuery = void 0;
...
var RequestContext = /** @class */ (function () {
    ...
    RequestContext.prototype.error = function (statusCode, message) {
        this.continue = false;
        return this._ctx.error(statusCode, message);
    };
    RequestContext.prototype.redirect = function (statusCode, location) {
        this.continue = false;
    ...
    RequestContext.prototype.graphqlErrors = function (errors) {
        this._ctx.error(500, errors.map(function (_a) {
